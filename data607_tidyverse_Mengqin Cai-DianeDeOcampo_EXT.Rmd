---
title: "Tidyverse"
author: "Mengqin Cai (Ext By Diane DeOcampo)"
date: "12/1/2019"
output:
  md_document:
...
-----------------------------------------------------------------------------------------------
#Diane DeOcampo's Extend:
```{r extend}
ggplot(Math_Score, aes(x=Test_preparation_course, y=Score)) + 
  geom_dotplot(binaxis='y', stackdir='center', dotsize=.5) +
  stat_summary(fun.y=mean, geom="point", size=4, color="red") +
  stat_summary(fun.y=median, geom="point", size=4, color="blue")
```
